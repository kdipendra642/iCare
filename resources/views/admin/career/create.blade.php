                            ...
                            <section class="panel" style="border: 2px solid #000; border-radius: 5px;">
                                <div class="panel-body">
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="text" id="department" name="department" value="" placeholder="Marketing, Finance, Development...">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="text" id="level" name="level" value="" placeholder="Senior, Mid, Beginner...">
                                        @if ($errors->has('level'))
                                            <span class="help-block" style="color:red">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="text" id="salary" name="salary" value="" placeholder="15000-50000 or Negotiable...">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="text" id="experience" name="experience" value="" placeholder="1+ year, 2+ year, 3+ year...">
