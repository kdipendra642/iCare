...
<div class="row">
       ...
       <section class="panel">
            ...
            <div class="panel-body">
                <form class=" form-horizontal" method="POST" action="{{ route('admin.settings.update',$general->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        <label class="control-label col-lg-2">Terms And Condition</label>
                        <div class="col-lg-10">
                            <textarea class=" form-control" name="terms_and_condition" id="article-ckeditor-terms">{{ $general->terms_and_condition}}</textarea>
                        </div>
                    </div>
                    <div class="form-group ">
                        <label class="control-label col-lg-2">Privacy Policy</label>
                        <div class="col-lg-10">
                            <textarea class=" form-control" name="privacy_policy" id="article-ckeditor-privacy">{{ $general->privacy_policy}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script>
     ...
     <script>
        CKEDITOR.replace( 'article-ckeditor-privacy' );
    </script>
     <script>
