    ...
    if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
      ...
      if (target.length) {
        ...
        if ($('body').hasClass('mobile-nav-active')) {
          ...
          $('.mobile-nav-toggle i').toggleClass('las la-bars las la-times');
...
$(function () {
          ...
          $('input, select').on('focusin', function () {
              $(this).parent().find('.input-group-text,select').css('border-color', '#01b0f8');
          });
          $('input, select').on('focusout', function () {
              $(this).parent().find('.input-group-text,select').css('border-color', '#D2C9C7');
          });
